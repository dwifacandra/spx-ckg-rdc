        ...
        <flux:sidebar.nav>
            ...
            <flux:sidebar.group expandable heading="Assets" class="grid">
                ...
                <flux:sidebar.group expandable heading="Transactions" class="grid">
                    ...
                    <flux:sidebar.item :href="route('assets.transactions.checkout')"
                        :current="request()->routeIs('assets.transactions.checkout')" wire:navigate>{{ __("Check Out")
                        }}</flux:sidebar.item>
                    <flux:sidebar.item :href="route('assets.transactions.index')"
