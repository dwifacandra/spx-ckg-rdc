            ...
            <flux:sidebar.nav>
                ...
                <flux:sidebar.group expandable heading="Assets" class="grid">
                    <flux:sidebar.item
                        ...
                        :current="request()->routeIs('assets.index')"
                        wire:navigate
                        >{{ __("Items") }}</flux:sidebar.item
                    >
                    ...
                    >
                        <flux:sidebar.item
                            :href="route('assets.transactions.checkin')"
                            :current="request()->routeIs('assets.transactions.checkin')"
                            wire:navigate
                            >{{ __("Check In") }}</flux:sidebar.item
                        >
                        <flux:sidebar.item
                            :href="route('assets.transactions.checkout')"
                            :current="request()->routeIs('assets.transactions.checkout')"
                            wire:navigate
                            >{{ __("Check Out") }}</flux:sidebar.item
                        >
                        <flux:sidebar.item
