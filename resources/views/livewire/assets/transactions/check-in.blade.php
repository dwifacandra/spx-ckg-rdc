<div class="p-6">
    ...
    {{-- Form Input Container (Menggunakan neutral-800) --}}
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        ...
        {{-- OPS Information Card (Menggunakan neutral-800 dan border neutral-700) --}}
        <div
        ...
        {{-- Asset Information Card (Menggunakan neutral-800 dan border neutral-700) --}}
        <div
            class="bg-white dark:bg-neutral-800 rounded-lg p-6 border border-gray-200 dark:border-neutral-700 h-40 overflow-auto">
            <h3 class="text-lg font-semibold mb-3 text-gray-900 dark:text-white">
                🏷️ Asset Information
    ...
    {{-- Recent Transactions Table Container (Menggunakan neutral-800) --}}
    <div class="bg-white dark:bg-neutral-800 shadow-sm rounded-lg overflow-hidden">
        ...
        <div class="overflow-x-auto">
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                ...
                {{-- Table Body (Menggunakan neutral-800) --}}
